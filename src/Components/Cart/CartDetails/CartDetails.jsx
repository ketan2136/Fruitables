...
//         let discount = 0;
//         if (subtotal > 1000) {
//             discount = subtotal * 0.1; // Apply a 10% discount
//         }
...
//                                         <div className>
//                                             <p className="mb-0">Flat rate: {discount}</p>
//                                         </div>
//                                     </div>
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <p className="mb-0">
                                                <CurrencyRupeeIcon />
                                                {subtotal > 2000 ? (subtotal * 0.2).toFixed(2) : subtotal > 1000 ? (subtotal * 0.1).toFixed(2) : 0}
                                            </p>
                                        </div>
                                    </div>
                                    <p className="mb-0 text-end">Shipping to Ukraine.</p>
